...
1. Create the environment from the snakemake8.yml file: `conda env create --name snakemake8 --file snakemake8.yml`
2. Activate the new environment: `conda activate snakemake8`
...
1. Update the path to your scratch directory (or whereever you run your code from) in line 4 of the Snakefile. Note that you may want to specify a subdirectory to keep the files organized. This subdirectory will automatically be created when running the pipeline. 
...
3. Update the path to your scratch directory (or whereever you run your code from) in line 4 of the Snakefile. Note that you may want to specify a subdirectory to keep the files organized. This subdirectory will automatically be created when running the pipeline. 
