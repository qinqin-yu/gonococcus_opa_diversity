...
blastn -db blastdb/gc -query FA1090_opa_1_reference_122_263.fa -out blast/opa_con1_blast.tab -num_threads 1 -max_hsps 15 -outfmt 7
blastn -db blastdb/gc -query FA1090_opa_1_reference_336_455.fa -out blast/opa_con2_blast.tab -num_threads 1 -max_hsps 15 -outfmt 7
blastn -db blastdb/gc -query FA1090_opa_1_reference_598_732.fa -out blast/opa_con3_blast.tab -num_threads 1 -max_hsps 15 -outfmt 7
